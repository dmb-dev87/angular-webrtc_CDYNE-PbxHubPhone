...
export class WebUser {
  /** Delegate. */
  public delegate: WebUserDelegate | undefined;

  private attemptingReconnection = false;
  private connectRequested = false;
  private logger: Logger;
  private held = false;
  private options: WebUserOptions;
   ...
   * @param options - Options bucket. See {@link WebUserOptions} for details.
   */
  constructor(server: string, options: WebUserOptions = {}) {
    // Delegate
    ...
    this.logger = this.userAgent.getLogger(`sip.WebUser`);
