import { Emitter, EmitterImpl } from 'sip.js';
import { StateTransitionError } from 'sip.js';
import { Transport as TransportDefinition } from 'sip.js';
import { TransportState } from 'sip.js';
import { Grammar, Logger } from 'sip.js/lib/core';
...
export class Transport implements TransportDefinition {
  ...
  private connectTimeout: null | ReturnType<typeof setTimeout> = null;

  private disconnectPromise: Promise<void> | undefined;
  private disconnectResolve: (() => void) | undefined;
  private disconnectReject: ((error?: Error) => void) | undefined;

  private keepAliveInterval: null | ReturnType<typeof setInterval> = null;
  private keepAliveDebounceTimeout: null | ReturnType<typeof setTimeout> = null;
